    ...
    switch(param->operation)
    {
        ...
        case GATTC_WRITE:
        {
            ...
            {      
                ...
                uart_printf("GATTC_WRITE find= %d\r\n",find);
        ...
        case GATTC_SDP_DISC_SVC_ALL:
        {
            if(param->status == ATT_ERR_NO_ERROR)
            {
                ...
                if(conidx<=MASTER_CONN_MAX)
                    appm_scan_fsm_next(); 
                
                uart_printf("all service discovered complete find=%x\r\n",find);
            }
...
static int gapm_ext_adv_report_ind_handler(ke_msg_id_t const msgid, struct gapm_ext_adv_report_ind *param,
                                        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t con_dev_str_name1[] ="BK3633_BLE789123";
    uint8_t con_dev_str_name2[] ="YYYKQ123";
