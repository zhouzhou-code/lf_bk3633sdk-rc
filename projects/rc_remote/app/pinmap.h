...
#define ADC_VBAT_PWR_EN   Port_Pin(1, 1)  //高电平有效

/* ============================================================================
 * 充电检测模块 (BQ24040 Charge IC)
 * 开漏输出，需内部上拉，低电平有效
 * ============================================================================ */
#define CHG_PGOOD         Port_Pin(1, 3)  // P13 - PGOOD（低=电源好）
#define CHG_CHRG          Port_Pin(1, 2)  // P12 - CHRG（低=充电中）
