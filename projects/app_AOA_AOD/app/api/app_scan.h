...
/// Scaning state machine
enum app_per_sync_state
{
    /// Scaning activity does not exists
    APP_PER_SYNC_STATE_IDLE = 0,
    /// Creating Scaning activity
    APP_PER_SYNC_STATE_CREATING,
    /// Scaning activity created
    APP_PER_SYNC_STATE_CREATED,
    /// Starting Scaning activity
    APP_PER_SYNC_STATE_STARTING,
    /// Scaning activity started
    APP_PER_SYNC_STATE_STARTED,
    /// Stopping Scaning activity
    APP_PER_SYNC_STATE_STOPPING,
