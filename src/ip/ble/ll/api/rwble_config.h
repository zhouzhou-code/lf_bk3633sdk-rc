...
////////////////////////////////////////////////////////////////////////////
/// Features byte 0
#define BLE_FEATURES_BYTE0  (  (CFG_BLE_SMP << BLE_FEAT_ENC                   ) \
                             | (1           << BLE_FEAT_CON_PARAM_REQ_PROC    ) \
                             | (1           << BLE_FEAT_EXT_REJ_IND           ) \
                             | (1           << BLE_FEAT_SLAVE_INIT_FEAT_EXCHG ) \
                             | (1           << BLE_FEAT_PING                  ) \
                             | (1           << BLE_FEAT_DATA_PKT_LEN_EXT      ) \
                             | (CFG_BLE_SMP << BLE_FEAT_LL_PRIVACY            ) \
                             | (CFG_BLE_SMP << BLE_FEAT_EXT_SCAN_FILT_POLICY  ) )
...
#define BLE_FEATURES_BYTE1  (  (BLE_PHY_2MBPS_SUPPORT         << (BLE_FEAT_2M_PHY            - 8) ) \
                             ...
                             | (CFG_BLE_EXT_ADV               << (BLE_FEAT_EXT_ADV           - 8) ) \
                             | (CFG_BLE_EXT_ADV               << (BLE_FEAT_PER_ADV           - 8) ) \
...
/// Features byte 3
#define BLE_FEATURES_BYTE3  (  (CFG_BLE_PER_SYNC_TRANSFER   << (BLE_FEAT_PER_ADV_SYNC_TRANSF_TX - 24) ) \
                             | (CFG_BLE_PER_SYNC_TRANSFER   << (BLE_FEAT_PER_ADV_SYNC_TRANSF_RX - 24) ) \
                             | (1                           << (BLE_FEAT_SLEEP_CLK_ACC_UPD - 24) ) )
